<aside
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-grow p-4 space-y-2">
            ...
            <a href="{{ route('buyer.recurring-orders.index') }}"
                class="flex items-center gap-3 px-4 py-2.5 font-semibold rounded-lg {{ request()->is('buyer/recurring-orders*') ? 'bg-primary-50 text-primary-600' : 'text-slate-600 hover:bg-slate-100 hover:text-dark' }}">
                <i class='bx bx-repeat text-xl'></i>
