                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ($randomProducts as $randomProduct)
                        <div
                            ...
                            <a href="{{ route('products.show', $randomProduct) }}" class="block">
                                <div class="relative">
                                    <img src="{{ Storage::url($randomProduct->main_image_path) }}"
                                        alt="{{ $randomProduct->name }}"
                                        class="w-full h-52 object-cover transition-transform duration-500 group-hover:scale-110"
                                        loading="lazy">
                                </div>
                                <div class="p-5 flex flex-col">
                                    <h3 class="text-lg font-bold text-dark mb-1 truncate">{{ $randomProduct->name }}</h3>
                                    <p class="text-slate-500 text-sm mb-4 truncate flex items-center">
                                        ...
                                        </svg>{{ $randomProduct->supplier->profile->business_name ?? $randomProduct->supplier->name }}
                                    </p>
                                    <div class="flex justify-between items-center pt-2 mt-auto border-t border-slate-100">
                                        <p class="text-lg font-extrabold text-primary-600">
                                            ...
                                            <span
                                                class="text-sm font-medium text-slate-500">/{{ $randomProduct->unit }}</span>
                                        </p>
                                    </div>
                                </div>
                            </a>
